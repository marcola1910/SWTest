...
public class FenwickTree<T> {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> ar = Arrays.asList(0, 3,2,-1,6,5,4,-3,3,7,2,3);
        ...
        System.out.println("sum(0, 5) = " + ft.query(0, 5));

        System.out.println("sum(0, 9) = " + ft.query(0, 9));

        System.out.println("sum(0, 10) = " + ft.query(0, 10));


        System.out.println("sum(4, 5) = " + ft.query(4, 5));

        System.out.println("sum(0, 6) = " + ft.query(0, 6));
